                ...
                <div class="w-full h-64 flex flex-col justify-between dark:bg-gray-800 bg-white dark:border-gray-700 rounded-lg border border-gray-400 mb-6 py-5 px-4"
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between text-gray-800 dark:text-gray-100">
                            ...
                            <button @click="onClick()" v-if="!show"
...
const editar = () =>{
    props.task.value
    //crear un nuevo formulario cuando le damos al boton de editar
    //en el archivo donde tenemos la estructura del task, vamos a hacer otro div igul pero que tengaa un input que tenga los nuevos 
    //valores, hacer un 
