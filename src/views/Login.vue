				...
				<div>
					...
					<div class="flex items-start">
						<div class="flex items-start">
							...
							<a href="#" class="text-sm text-blue-700 hover:underline ml-auto dark:text-blue-500">Has olvidado tu contraseña?</a>
						</div>
						...
						<div class="text-sm font-medium text-gray-500 dark:text-gray-300">
							No estas registrado?  <router-link :to="{name: 'register'}" href="#" class="text-blue-700 hover:underline dark:text-blue-500">REGISTRATE!
							</router-link>
						</div>
		</form>
	</div>
